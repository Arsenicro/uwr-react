  ...
  return (
    <Box sx={{
      ...
      >
        ...
        <Button type="submit" variant="contained" color="primary" sx={{ mt: 2 }} loading={apiLoading}>{saveText}</Button>
        <Button type="button" variant="text" color="secondary" sx={{ mt: 2, ml: 2 }} onClick={onClose} loading={apiLoading}>Cancel</Button>
